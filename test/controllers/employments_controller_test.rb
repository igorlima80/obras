...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post employments_url, params: { employment: { admission_date: @employment.admission_date, base_salary: @employment.base_salary, person_id: @employment.person_id, place_id: @employment.place_id, resignation_date: @employment.resignation_date } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { admission_date: @employment.admission_date, base_salary: @employment.base_salary, person_id: @employment.person_id, place_id: @employment.place_id, resignation_date: @employment.resignation_date } }
