...
class BenefitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create benefit" do
    assert_difference('Benefit.count') do
      post benefits_url, params: { benefit: { benefit_type_id: @benefit.benefit_type_id, employment_id: @benefit.employment_id, value: @benefit.value } }
    end
  ...
  test "should update benefit" do
    patch benefit_url(@benefit), params: { benefit: { benefit_type_id: @benefit.benefit_type_id, employment_id: @benefit.employment_id, value: @benefit.value } }
