class AddMenu < SeedMigration::Migration
  def up
    ...
    planning = MenuItem.create name: 'Planejamento', icon: 'fas fa-project-diagram', link: '#', position: 2, target: '_self', permission: 'manage', permission_check: 'all', menu_item_id: nil, active_test: "", published: true
      MenuItem.create name: 'Tipos de Construções', icon: 'fas fa-landmark', link: 'construction_types_path', position: 1, target: '_self', permission: 'manage', permission_check: 'ConstructionType', menu_item: planning, published: true, active_test: "controller_name == 'construction_types'"     
      MenuItem.create name: 'Etapas', icon: 'fas fa-bars', link: 'stages_path', position: 2, target: '_self', permission: 'manage', permission_check: 'Stages', menu_item: planning, active_test: "controller_name == 'stages'", published: true
      MenuItem.create name: 'Sub-Etapas', icon: 'fas fa-tasks', link: 'sub_stages_path', position: 3, target: '_self', permission: 'manage', permission_check: 'SubStages', menu_item: planning, active_test: "controller_name == 'sub_stages'", published: true
