class AddMenu < SeedMigration::Migration
  def up
    ...
    MenuItem.create name: 'Etapas', icon: 'fas fa-tasks', link: 'stages_path', position: 2, target: '_self', permission: 'manage', permission_check: 'Stages', menu_item: construcao, active_test: "controller_name == 'stages'", published: true
